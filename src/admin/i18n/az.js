...
export default {
  ...
  verification: {
    ...
    eventNote: 'Huni {{count}} qeyd olunmuş məhsul hadisəsindən hesablanıb. Hadisəsi olmayan mərhələ 0 göstərir; təklifi olmayan konversiya — göstərir, heç vaxt 0%.',
    colOrder: 'Sifariş',
    colToken: 'Token',
    colTier: 'Tarif',
    colStatus: 'Status',
    ...
    funnel: {
      ...
      conversion: 'Təklif → aktivləşdirmə',
  ...
  queue: {
    ...
    db: {
      ...
      host: 'Server',
      name: 'Baza adı',
      migrated: 'Faza 5 cədvəlləri mövcuddur',
      lease: 'Növbə icazəsi',
      yes: 'Bəli',
      no: 'Xeyr',
