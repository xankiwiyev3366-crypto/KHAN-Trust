...
export default {
  ...
  verification: {
    ...
    eventNote: 'Funnel computed from {{count}} recorded product events. A stage with no events shows 0; a conversion rate with no quotes shows — , never 0%.',
    colOrder: 'Order',
    colToken: 'Token',
    colTier: 'Tier',
    colStatus: 'Status',
  ...
  queue: {
    ...
    db: {
      ...
      host: 'Host',
      name: 'Database name',
      migrated: 'Phase 5 tables present',
      lease: 'Queue lease',
      yes: 'Yes',
      no: 'No',
